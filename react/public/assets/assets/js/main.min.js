...
function handleDisplayChatboxClick() {
    var options = {
        direction: 'right'
    };
    $('.showChat').toggle('slide', options, 500);
...
function toggleExtraProfileList() {
    $(".extra-profile-list").slideToggle();
}

function toggleShowChatInner() {
    var options = {
        direction: 'right'
    };
    $('.showChat_inner').toggle('slide', options, 500);
}
function toggleBackChatBox() {
    var options = {
        direction: 'right'
    };
    $('.showChat_inner').toggle('slide', options, 500);
...
// Function to activate the sidebar push menu
...
// Function to activate sidenav treemenu
function activateSideNavTreemenu(menu) {
    var _this = this;
    var animationSpeed = 200;
    $(document).on('click', menu + ' li a', function(e) {
        // Get the clicked link and the next element
        ...
        // Prevent the page from being redirected if this isn't a link
        if (checkElement.is('.treeview-menu')) {
            e.preventDefault();
        }
    });
...
// Call the functions to activate push menu and sidenav treemenu
activatePushMenu("[data-toggle='offcanvas']");
activateSideNavTreemenu('.sidebar');



// function activatePushMenu() {
//     // Your push menu activation logic here using jQuery
//     if ($(window).width() > 767) {
//         if ($("body").hasClass('sidebar-collapse')) {
//             $("body").removeClass('sidebar-collapse').trigger('expanded.pushMenu');
//         } else {

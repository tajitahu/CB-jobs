...
<main class="home">
    <section class="home__lid">
        <div class="def-width">
            ...
            <div class="home__lid-butn">
                <a onclick="ga('gtm1.send','event','joinus','button');" href="/signup" class="butn butn-yellow">
    ...
    <section class="home__offer1 bg-gray-900 d-none">
        <div class="def-width flex">
            <div class="home__offer-left">
            ...
            <div class="home__offer-right">
                <div class="like-h1">THE SALARY YOU CAN EARN PER MONTH</div>
                    ...
                    <table>
                        <tr>
                            ...
                            <th>Salary</th>
                                                    ...
                                                    <tr>
                                <td rowspan="2">ENL WRITERS<span>English Native Language</span></td>
                                <td>ID 1**2</td>
                                <td>330</td>
                                ...
                                <td><strong>$2967</strong></td>
                                                                            ...
                                                                            <tr>
                                <td rowspan="2">ESL WRITERS<span>English Second Language</span></td>
                                <td>ID 8**2</td>
                                <td>284</td>
...
<div class="home__currently-butn">
    ...
    <section class="home__review" id="home__review">
        <div class="def-width">
            <div class="like-h1">What our clients say</div>
            <ul class="home__review-slider">
                <li>
                    <img src=" assets/images/testimonial6.png" width="126" height="126" class="retina" title="Kenya writer freelancer Sarah H" alt="writer freelancer from Kenya Sarah H">
                    <div class="reviewer-name">Sarah H.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_half.svg" alt="">
                    </div>
                    <p>Your support team is awesome! They never jump into conclusions without analyzing a situation carefully. </p>
                </li>
                <li>
                    <img src=" assets/images/photo_male_5.png" width="126" height="126" class="retina" title="freelance writer from Pakistan Rahul" alt="pakistan freelance writer Rahul">
                    <div class="reviewer-name">Rahul N.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                    ...
                    <p>Now I can manage my personal time better. I can work whenever I want and still receive good money!</p>
                </li>
                <li>
                    <img src=" assets/images/testimonial5.png" width="126" height="126" class="retina" title="Philippines freelance writer Kira V" alt="philippines writer Kira V">
                    <div class="reviewer-name">Kira V.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_empty.svg" alt="">
                    </div>
                    <p>This is a great company! Thanks to ProWritersTime.com I can afford to receive a Master's degree.</p>
                </li>
                <li>
                    <img src=" assets/images/photo_female_1.png" width="126" height="126" class="retina" title="freelance essay writer Shreya P" alt="essay writer Shreya P">
                    <div class="reviewer-name">Shreya P.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                    ...
                    <p>Being a mom is not easy but thanks to ProWritersTime.com I can provide for my child!</p>
                </li>
                <li>
                    <img src=" assets/images/photo_male_4.png" width="126" height="126" class="retina" title="freelance USA writer Yash M" alt="freelance writer Yash M">
                    <div class="reviewer-name">Yash M.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                    ...
                    <p>This is a great freelancing site!  Work processes are very simple and always go smoothly here!</p>
                </li>
                <li>
                    <img src=" assets/images/testimonial3.png" width="126" height="126" class="retina" title="writer freelancer Tom W" alt="writer Tom W">
                    <div class="reviewer-name">Tom W.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                    ...
                    <p>I feel valued here! ProWritersTime.com is tough on quality but they pay well.</p>
                </li>
                <li>
                    <img src=" assets/images/photo_female_2.png" width="126" height="126" class="retina" title="essay writer freelancer Ishita B" alt="writer freelancer Ishita B">
                    <div class="reviewer-name">Ishita B.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                    ...
                    <p>I love travelling! Now I can do it! Thanks ProWritersTime.com team!</p>
                </li>
                <li>
                    <img src=" assets/images/testimonial9.png" width="126" height="126" class="retina" title="USA writer Daniel J" alt="USA freelance writer Daniel J">
                    <div class="reviewer-name">Daniel J.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                    ...
                    <p>I have enhanced my knowledge and even improved my English thanks to you!</p>
                </li>
                <li>
                    <img src=" assets/images/photo_female_3.png" width="126" height="126" class="retina" title="freelance writer Neha H" alt="freelance essay writer Neha H">
                    <div class="reviewer-name">Neha H.</div>
                    <div class="star">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                        <img src=" assets/images/svg/ic_star_full.svg" alt="">
                    ...
                    <p>With ProWritersTime.com I earn good money without compromising on time I spend with my young family! </p>
                </li>
            </ul>
        </div>
    </section>
    <!-- content cta -->
<section class="home__register_now" style="background-image: url(' assets/images/img_cta@3x.png')">
    <div class="inner">
        ...
        <div class="register_now_btn">
            <div class="home__lid-butn">
                <a href="/signup" class="butn butn-yellow no-effect">
                    <span class="showed-text">register now</span>
                </a>
            </div>
        </div>
        ...
        <div class="def-width">
            ...
            <div class="home__seo-text-content">
                <h1>JOB CENTRES AFRICA!</h1>
                <p>
                   Welcome to Job Centres Africa, your premier platform for unlocking career opportunities and connecting talent with leading companies across the continent. Our mission is to empower individuals, businesses, and training providers through innovative solutions and personalized services.
                </p>
                <div id="seo-text-read-more" class="read-more">
                   
                    <p>
                        At Job Centres Africa, we believe in the transformative power of employment. We are dedicated to bridging the gap between job seekers and employers, providing comprehensive support, and fostering a thriving ecosystem for career growth and development.
                    </p>
                   <p>
                       With a commitment to transparency, fairness, and excellence, we strive to create meaningful connections, facilitate seamless communication, and deliver exceptional value to our users. Whether you're an applicant, employer, training provider, or agency, Job Centres Africa is your trusted partner in navigating the dynamic world of employment.
                   </p>

                  <p>
                      Join us on this journey of empowerment, opportunity, and success. Together, let's build a brighter future for Africa's workforce.
                  </p>
                </div>
                <p><a href="#seo-text-read-more" class="read-more-link">Read More ...</a></p>
            </div>
        </div>
    </section>
</main>
        ...
        <div class="newsletter-inner-wrap">
            <div class="newsletter-inner">
                <div class="newsletter-left-col">
                    ...
                    <form class="send-mail" action="/signup">
                        ...
                        <button type="button" class="butn butn-yellow no-effect" onclick="startEarning($(this));">
